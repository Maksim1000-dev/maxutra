...
// Полная логика звонков с демонстрацией экрана и сворачиванием
...
const CallManager = {
    ...
    async startScreenShare() {
        try {
            ...
            // Обработка остановки демонстрации пользователем
            screenTrack.onended = () => {
                this.stopScreenShare();
            };
